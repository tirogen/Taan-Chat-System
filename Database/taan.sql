...
CREATE DATABASE IF NOT EXISTS `taan` CHARACTER SET utf8mb4 COLLATE=utf8mb4_unicode_ci;
USE `taan`;
...
--
ALTER TABLE `room_user`
  ADD CONSTRAINT `room_user_ibfk_1` FOREIGN KEY (`room_id`) REFERENCES `rooms` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `room_user_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
